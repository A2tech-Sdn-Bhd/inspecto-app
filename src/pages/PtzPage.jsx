...
function PtzPage({
  ...
  const [url, setUrl] = useState("http://192.168.88.246:8089/video_feed");
  ...
  useEffect(() => {
    ...
    if (cam == 1) {
      ...
      // stopchrome();
      setUrl("http://192.168.88.246:8089/video_feed")
    }
  }, [cam]);
  useEffect(() => {
    if (!edgeFront) {
        ...
        <>
          <div className="grid grid-cols-12 gap-4 mt-10">
            <div className="col-span-2 flex flex-col justify-center">
              <ListCameraCard setCam={setCam} showPtzButton={showPtzButton}/>
